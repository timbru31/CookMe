...
public class CookMeCommands implements CommandExecutor {
	...
	private String message, effect;
	private String[] effects = {"damage", "death", "venom", "hungervenom", "hungerdecrease", "weakness", "slowness", "slowness_blocks", "confusion", "blindness", "hungervenom", "hungerdecrease"};
	private int i;
